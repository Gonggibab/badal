...
type EditUploadIamgeProps = {
  exImages: ImageType[];
  setExImages: Dispatch<SetStateAction<ImageType[]>>;
  exDetailImage: ImageType | undefined;
  setExDetailImage: Dispatch<SetStateAction<ImageType | undefined>>;
...
export default function EditUploadIamge({
  exImages,
  setExImages,
  exDetailImage,
  setExDetailImage,
  ...
  const deleteExDetailImg = () => {
    setExDetailImage(undefined);
    setDeleteImages(deleteImages.concat([exDetailImage!]));
  };
